...
from consts import print_project_label, is_windows, build_folder

print_project_label("Build")

build_params = "-s compiler.cppstd=17 -c tools.system.package_manager:mode=install -c tools.system.package_manager:sudo=True"

cmd("conan install . {0} --build=missing".format(build_params))
